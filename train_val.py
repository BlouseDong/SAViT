...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='./Dataset/FSC147/', type=str,
                        help='dataset path')

    parser.add_argument('--output_dir', default='./Dataset/FSC147/train',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./Dataset/FSC147/train',
                        help='path where to tensorboard log')
    parser.add_argument('--device', default='cuda:0',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=314, type=int)

    parser.add_argument('--resume', default=r'D:\zhiwei\CACViT\best-model.pth',
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and epoch >= 0 and epoch % 2 == 0:
