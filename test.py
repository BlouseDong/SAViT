...
def get_args_parser():
    ...
    parser.add_argument('--resume', default=r'D:\zhiwei\CACViT\Dataset\FSC147\train\mybest.pth',
                        help='resume from checkpoint')
    # D:\zhiwei\CACViT\Dataset\FSC147\train\mybest.pth
    # D:\zhiwei\CACViT\best-model.pth
...
def main(args):
    ...
    for data_iter_step, (samples, gt_dots, boxes, pos, gt_map, im_id, scale) in enumerate(
